...
- [x] **Implement chosen monthlyEstimate formula** (gated on §4)  *— shipped in `03f76dc`; §4 resolved as Option D (Google Solar yearlySavings/12 when covered; hidden otherwise)*
