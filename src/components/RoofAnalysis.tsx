    ...
    <div className="space-y-4">
      ...
      {bestSegment && bestSegment.panelCount > 0 && (
        <div className="bg-gradient-to-r from-green-900/20 to-emerald-900/20 border border-green-700/30 rounded-lg p-3">
          <div className="flex items-center justify-between">
            <div>
              <div className="text-xs text-green-400 font-medium">Best Roof Section</div>
  ...
  return (
    <div className="flex items-center gap-4 text-sm">
      ...
      <div>
        ...
        <span className="text-green-400 font-medium">${Math.round(roofSummary.yearlySavings).toLocaleString()}/yr</span>
      </div>
    </div>
  )
}
