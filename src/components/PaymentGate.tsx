    ...
    <div className="bg-[#0a0a0a] border border-gray-700/50 rounded-2xl p-8 max-w-md w-full mx-auto shadow-2xl shadow-black/50 animate-fade-in">
        ...
        <div className="mb-6 p-4 bg-green-900/20 border border-green-700/50 rounded-xl">
          <div className="flex items-center gap-3 text-green-400">
            ...
            <div>
              ...
              <span className="text-sm text-green-400/70">Refreshing data...</span>
            </div>
          </div>
        </div>
      )}
      ...
      {!isConnected ? (
        <div className="space-y-4">
          ...
          <Wallet>
            <ConnectWallet className="!w-full !bg-green-600 hover:!bg-green-500 !rounded-xl !py-4 !font-semibold !text-base !justify-center !shadow-lg !shadow-green-500/20" />
          </Wallet>
        </div>
      ) : (
...
export function UpgradeBanner({
  ...
  return (
    <div className="bg-gradient-to-r from-green-900/30 to-emerald-900/30 border border-green-700/50 rounded-xl p-5 flex items-center justify-between gap-4">
      ...
      <button
        onClick={onUpgrade}
        className="px-5 py-2.5 bg-green-600 hover:bg-green-500 text-white font-medium rounded-xl transition-all shadow-lg shadow-green-500/20 whitespace-nowrap"
      >
        Upgrade
      </button>
    </div>
