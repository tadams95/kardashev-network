...
export default function SCInteraction({ ethereumAddress }: any) {
  ...
  return (
    <>
      ...
      <ul className="grid grid-cols-1 my-4 gap-6 rounded-md p-4 border-4 border-cyan-900 sm:grid-cols-2 lg:grid-cols-2">
        ...
        <button
          ...
          className="rounded-md border-2 border-cyan-900 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-cyan-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
          onClick={setMinter}
        >
          Set Producer
        </button>
        ...
        <div className="border-2 border-gray-200 rounded-md p-1">
          ...
          <div className="my-4">
            <input
              ...
              id="recipientAmount"
              className="block w-full rounded-md border-1 p-1 text-black shadow-sm ring-1 ring-inset placeholder:text-gray-600 focus:ring-2 focus:ring-inset focus:ring-cyan-700 sm:text-sm sm:leading-6"
      ...
      <ul className="grid grid-cols-1 my-4 gap-6 rounded-md p-10 border-4 border-cyan-900 sm:grid-cols-1 lg:grid-cols-1">
        {/* Mint Energy Token Button */}
        <button
          type="button"
          className="rounded-md bg-cyan-700 px-3.5 text-lg font-semibold text-white shadow-sm hover:bg-cyan-700 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-700"
          onClick={mintTokens}
        >
          Mint Energy Tokens
        </button>
