    ...
    <div className="relative min-h-screen overflow-hidden bg-[#050505] ">
      ...
      <div className="relative z-20 flex flex-col items-center justify-center min-h-screen px-6 lg:px-8 pointer-events-none">
        <div className="max-w-3xl text-center">
          {/* Badge */}
          <div className="mb-6 inline-flex items-center gap-2 px-4 py-2 rounded-full bg-cyan-300/30 border border-cyan-700/20 pointer-events-auto animate-hero-fade-in hero-delay-1">
            <span className="w-2 h-2 rounded-full bg-cyan-300 animate-pulse" />
            <span className="text-sm text-cyan-300 font-medium">Live Solar Data</span>
          </div>

          <h1 className="text-4xl font-bold tracking-tight text-white sm:text-6xl lg:text-7xl animate-hero-fade-in hero-delay-2">
            Every second, millions in solar energy goes{' '}
            <span className="gradient-text">uncaptured</span>
          </h1>

          <p className="mt-6 text-lg sm:text-xl leading-8 text-gray-300 max-w-2xl mx-auto animate-hero-fade-in hero-delay-3">
            See how much energy is hitting your location right now — and the dollar value of what&apos;s being wasted.
          </p>

          <div className="mt-8 max-w-lg mx-auto pointer-events-auto animate-hero-fade-in hero-delay-4">
            <LocationSearch navigateToDashboard />
          </div>

          <p className="mt-4 text-sm text-gray-100 animate-hero-fade-in hero-delay-4">
            Enter your location or allow access to see real-time solar irradiance data
          </p>

          {/* Trust indicators */}
          <div className="mt-10 flex flex-wrap items-center justify-center gap-x-8 gap-y-4 text-sm text-gray-100 animate-hero-fade-in hero-delay-5">
