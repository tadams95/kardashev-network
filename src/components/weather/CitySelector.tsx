  ...
  return (
    <Listbox value={value} onChange={onChange}>
      <div className="relative inline-block">
        <Listbox.Button className="inline-flex items-center gap-1 border-b border-amber-500/50 text-white hover:border-amber-400 transition-colors focus:outline-none cursor-pointer">
          <span>{selectedCity.name}</span>
          <ChevronUpDownIcon className="h-5 w-5 text-amber-400" aria-hidden="true" />
        </Listbox.Button>
        <Transition
          as={Fragment}
